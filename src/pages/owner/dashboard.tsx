      ...
      try {
        ...
        (apptsWithPrice || []).forEach((a: any) => {
          ...
          if (barberId) {
            ...
            barberNames[barberId] =
              a.barber?.profile_id?.full_name || "Barbeiro";
          }
        });
        ...
        const barberPerf: BarberPerformance[] = Object.keys(barberCounts).map(
          (id) => ({
            id,
            name: barberNames[id],
