                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold">
                      {secondAppt.client?.full_name}
                    </p>
                    <p className="text-sm text-muted-foreground">
                      {secondAppt.service.name}
                    </p>
                  </div>
                </div>
                <div className="text-right">
          ...
          {appointments.length === 0 ? (
            ...
            appointments.map((appt) => {
              ...
              return (
                <Card
                  key={appt.id}
                  className={`border-none shadow-sm transition-all ${isCompleted ? "opacity-60 bg-muted/50" : "hover:shadow-md bg-card"}`}
                >
                  <CardContent className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div
                        className={`text-center min-w-[60px] ${isCompleted ? "text-muted-foreground" : "text-primary"}`}
                      >
