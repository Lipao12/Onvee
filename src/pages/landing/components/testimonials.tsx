...
const testimonialsList: Testimonial[] = [
  {
    quote: "Reduzi as faltas em 40% com os lembretes automáticos. O sistema se pagou na primeira semana.",
    author: "Carlos Silva",
    role: "Proprietário",
    company: "Barbearia Urban Cut"
  },
  {
    quote: "Meu fluxo de clientes aumentou muito depois que passei a usar o agendamento online. Eles adoram a praticidade.",
    author: "José Almeida",
    role: "Master Barber",
    company: "Barbearia do Zé"
  },
  {
    quote: "Simplesmente o melhor app de gestão que já usei. O suporte é incrível e o app nunca trava.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {testimonialsList.map((t, i) => (
            <div key={i} className="bg-gray-50 p-8 rounded-2xl relative">
              <div className="flex gap-1 mb-6">
                {[...Array(5)].map((_, starI) => (
                  <Star key={starI} className="h-5 w-5 text-yellow-400 fill-current" />
                ))}
              </div>
        ...
        <div className="mt-20 pt-10 border-t border-gray-100">
            ...
            <div className="flex flex-wrap justify-center items-center gap-12 opacity-50 grayscale transition-all hover:grayscale-0 hover:opacity-100">
                ...
                <span className="text-2xl font-extrabold tracking-widest">RAZOR SHARP</span>
