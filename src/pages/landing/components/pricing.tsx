      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
            ...
            <span className="text-neutral-600 relative">
              no primeiro dia
              <svg
                className="absolute w-full h-2 -bottom-1 left-0 text-neutral-200 -z-10"
                viewBox="0 0 100 10"
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            Escolha o período que melhor se adapta ao seu fluxo de caixa. Todos
            os planos incluem acesso completo a todas as funcionalidades.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-start">
          ...
          <div className="group bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover:border-neutral-100 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <Button
                variant="outline"
                className="w-full mb-8 py-6 text-base font-semibold border-gray-200 hover:border-neutral-200 hover:bg-neutral-50 hover:text-neutral-700 transition-all"
              >
                Começar agora
              </Button>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-2xl border-2 border-neutral-600 relative transform md:-translate-y-4 z-10 flex flex-col h-full">
            ...
            <div className="flex flex-col h-full pt-4">
              ...
              <p className="text-gray-500 text-sm mb-8">
                O equilíbrio ideal para crescer.
              </p>

              <div className="mb-2 flex items-baseline gap-1">
                <span className="text-6xl font-extrabold text-neutral-600 tracking-tight">
                  R$ 79
                </span>
                <span className="text-gray-500 font-medium text-lg">/mês</span>
              </div>
              ...
              <Button
                size="lg"
                className="w-full mb-8 py-7 text-base font-bold shadow-lg shadow-neutral-600/20 hover:shadow-neutral-600/40 transition-all"
              >
              ...
              <div className="space-y-5 flex-1">
                ...
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-start gap-3 text-sm text-gray-900 font-medium"
                  >
        ...
        <div className="mt-24 flex flex-col items-center justify-center gap-8">
          ...
          <div className="flex gap-6 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            <div className="h-8 w-12 bg-gray-200 rounded flex items-center justify-center text-[10px] font-bold text-gray-400">
              VISA
            </div>
            <div className="h-8 w-12 bg-gray-200 rounded flex items-center justify-center text-[10px] font-bold text-gray-400">
              MASTER
